...
const int pin_interrupt = 17; // default interrupt pin on ATmega8/168/328 is 2
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(17), interrupt_routine, CHANGE); // interrupt 0 equivalent to pin 2(INT0) on ATmega8/168/328
  last_time = millis();
  interrupts();
}
